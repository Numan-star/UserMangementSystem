                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick="return confirm('Are you sure you want to delete this?')"
                                        ...
                                        href="<?php echo base_url() . 'Crud/delete/' . $val['id'] ?>">Delete </a>
                                </td>
                                <td>
                                    <a class="btn btn-info"
                                        href="<?php echo base_url() . 'Crud/edit/' . $val['id'] ?>">Edit</a>
                                </td>
                            </tr>
                            <?Php }
} else {
...
?>
                ...
                <div class="col-md-4">
                    <h1>Create User</h1>
                    <form method="POST" action="<?=base_url() . 'Crud/index'?>">
                        <div class="mb-3">
                        ...
                        <button type="submit" name="save" value="index" class="btn btn-primary">Submit</button>
